...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.centralwidget.setStyleSheet("/*QGroupBox公用属性设置*/\n"
" QGroupBox {\n"
...
"")
        ...
        self.bme280_humidity_bar.setStyleSheet("QProgressBar {\n"
"    text-align: center;\n"
...
"}")
        ...
        self.bme280_pressure_bar.setStyleSheet("QProgressBar {\n"
"    text-align: center;\n"
"    color: rgb(240, 240, 240);\n"
"    border-width: 1px; \n"
"    border-radius: 10px;\n"
...
"}")
        ...
        self.bme280_sealevel_bar.setStyleSheet("QProgressBar {\n"
"    text-align: center;\n"
"    color: rgb(240, 240, 240);\n"
"    border-width: 1px; \n"
"    border-radius: 10px;\n"
...
"")
        ...
        self.cpu_temp_slider.setGeometry(QtCore.QRect(50, 30, 22, 201))
        self.cpu_temp_slider.setStyleSheet("QSlider::groove:vertical{\n"
"border: 1px solid #637EB8;\n"
"background: white;\n"
"width:7px;\n"
"height: 175px;\n"
...
"")
        ...
        self.cpu_temp_slider.setTickPosition(QtWidgets.QSlider.TicksAbove)
        self.cpu_temp_slider.setObjectName("cpu_temp_slider")
        self.progressBar_2 = QtWidgets.QProgressBar(self.cpu_utilization)
        self.progressBar_2.setGeometry(QtCore.QRect(80, 40, 41, 181))
...
"}")
        ...
        self.verticalSlider = QtWidgets.QSlider(self.cpu_utilization)
        self.verticalSlider.setGeometry(QtCore.QRect(330, 30, 41, 201))
...
"")
        ...
        self.lcdNumber_2.setGeometry(QtCore.QRect(250, 110, 71, 31))
        ...
        self.verticalSlider.valueChanged['int'].connect(self.lcdNumber_2.display)
